	...
	<div style="padding: 0px;">
		<div class="row">
			<div class="col-sm-12 general-setting w3-hide-small w3-light-grey w3-card-2">
				<form action="BorrowCouponManagmentDeptApprove" method="POST">
					...
					<div class="row" style="margin-top: 10px;">
						<div class="col-sm-12">
							<div class="form-group">
								...
								<div class="input-group">
									<input type="text" style="text-transform: uppercase;" class="form-control" name="status_asset" value="${coupon.getApprove_comment()}">
								</div>
							</div>
						</div>
						<div class="col-sm-12">
