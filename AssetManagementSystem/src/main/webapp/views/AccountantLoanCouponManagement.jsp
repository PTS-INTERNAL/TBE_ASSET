	...
	<div style="padding: 0px;">
		<div class="row">
			<div class="col-sm-12 general-setting shadow-sm p-3 mb-5 bg-gray">
				<form action="AccountantLoanCouponManagement" method="POST">
							...
							<c:forEach var="p" items="${lst}">
								<tr>
									...
									<td style="width: 160px;"><c:if test="${p.getStatus()=='1'}">
											...
											<form action="LoanCouponManagmentAccountApprove" method="post" style="width: 190px;">
												<input style="display: none;" name="coupon_cd" value="${p.getCoupon_cd()}">
											...
											<form action=LoanCouponManagmentAccountApprove method="post" style="width: 190px;">
												<input style="display: none;" name="coupon_cd" value="${p.getCoupon_cd()}">
												<button style="width: 190px; margin: auto; background-color: pink; color: black;" type="submit" class="view" name="approveExport">ĐANG MƯỢN</button>
											</form>
										</c:if> <c:if test="${p.getStatus()=='4'}">
											<form action="LoanCouponReturnAccountantApprove" method="post" style="width: 190px;">
												<input style="display: none;" name="coupon_cd" value="${p.getCoupon_cd()}">
												<button type="submit" class="view" style="width: 190px; margin: auto; background-color: orange;" name="init">XÁC NHẬN TRẢ</button>
											</form>
