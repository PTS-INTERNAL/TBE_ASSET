		...
		<div class="w3-card-4"
			...
			<div class="w3-container w3-center" style="padding: 10px;">
				...
				<div class="w3-section" style="width:300px; margin:auto;">
					<form action="BorrowAssetConfirmReturn" method="post" style="width: 60px; float:left; margin-right:120px">
						<input style="display: none;" name="borrow_cd" value="${borrow.getId()}">
						<button type="submit" class="w3-button w3-green" name="confirm">XÁC NHẬN ĐÃ TRẢ</button>
					</form>
					<form action="BorrowAssetApprove" method="post" style="width: 60px; float: left">
						<input style="display: none;" name=""borrow_cd"" value="${borrow.getId()}">
						<button type="submit" class="w3-button w3-red" name="disApprove">KHÔNG DUYỆT</button>
					</form>
				</div>
			</div>
