					...
					<div class="col-sm-4">
							<div class="form-group">
								<label class="title_input">TÊN TÀI SẢN:<span class="require">*</span></label> <input
									type="text"  value="${asset.getAsset().getName() }" class="form-control" name="asset_name">
							</div>
						</div>
						<div class="col-sm-4">
						...
						<div class="col-sm-4">
							...
							<div class="input-group">
								<span class="input-group-addon"> </span> <input type="text"
									class="form-control inputAssetItem"  value="${asset.getDept().getDept_name() }" readonly="readonly" name="department_name"
									id="department_name" > <input type="text"
									class="form-control inputAssetItem" style="display: none;"
									name="department_cd"   value="${ asset.getDept().getDept_cd() }" id="department_cd">
								<button type="button" class="select"
