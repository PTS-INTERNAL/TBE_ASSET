				...
				<c:if test="${asset!=null}">
					...
					<div class="row">
						<div class="col-sm-4">
							...
							<div class="input-group">
								<span class="input-group-addon"> </span> <input type="text"
									class="form-control inputAssetItem"  name="group_asset_na"
						...
						<div class="col-sm-4">
							<div class="form-group">
								<label class="title_input">MÃ RFID:<span class="require">*</span></label> <input type="text"
									class="form-control"  value="${asset.getRFID() }" readonly="readonly" name="asset_rfid">
							</div>
						</div>
						<div class="col-sm-4">
							<div class="form-group">
						...
						<div class="col-sm-4">
							...
							<div class="input-group">
								<span class="input-group-addon"> </span> <input type="text"
									class="form-control inputAssetItem"  value="${asset.getDepartment_name() }"  name="department_name"
						...
						<div class="col-sm-4">
							...
							<div class="input-group">
								 <input type="number"
									class="form-control"   value="${asset.getMaintaince().trim() }" min="1" name="asset_maintaince"> <span style="line-height:35px;margin-left:10px;" class="title_input">THÁNG</span>
							</div>
						</div>
						<div class="col-sm-12">
							<div class="form-group">
								<label class="title_input" >GHI CHÚ:</label>
								<textarea style="resize: none;" class="form-control"   name="asset_note">${asset.getNote() }</textarea>
							</div>
						</div>
						<div class="col-sm-12">
							<div class="form-group">
								<label class="title_input" >GIẢI TRÌNH LÝ DO CHỈNH SỬA:<span class="require">*</span></label>
								<textarea style="resize: none;" class="form-control"   name="update_reason">${reason}</textarea>
							</div>
						</div>
					</div>
