	...
	<div style="padding: 0px;">
		<div class="row">
			<div class="col-sm-12 general-setting w3-hide-small w3-light-grey w3-card-2">
				<form action="ReturnAssetDeclare" method="POST">
					...
					<div class="row">
						<div class="col-sm-4">
							<div class="form-group">
								<label class="title_input">CÔNG TY TRẢ:</label>
						...
						<div class="col-sm-4">
							<div class="form-group">
								<label class="title_input">CÔNG TY NHẬN: </label>
								<div class="input-group">
						...
						<div class="col-sm-4">
							<div class="form-group">
								<label class="title_input">ĐƠN VỊ TRẢ:</label>
						...
						<div class="col-sm-4">
							<div class="form-group">
								<label class="title_input">ĐƠN VỊ NHẬN:</label> <input type="text" value="${coupon.getDept_client().getDept_name()}" class="form-control" readonly="readonly" name="number_on">
							</div>
						</div>
						<div class="col-sm-4">
							<div class="form-group">
								<label class="title_input">NGÀY TRẢ:</label> <input type="text" value="${coupon.getDate_start()}" class="form-control" readonly="readonly" name="number_on">
							</div>
						</div>
						<div class="col-sm-12">
							<div class="form-group">
								...
								<div class="input-group">
									<input type="text"  class="form-control" style="height: 40px; text-transform: uppercase;" name="cmpn_na_client" readonly="readonly" value="${coupon.getReason()}" id="cmpn_na_client">
						...
						<tbody>
							...
							<c:forEach begin="${startIndex}" end="${endIndex}" step="1" var="index">
								<tr>
									...
									<td style="text-align: center;"><input type="text" class="form-control" name="borrow[<%=stt%>]_cd" value="${lstBr.get(index-1).getId()}" style="display: none; height: 30px; margin: 2px;"> <input type="text" class="form-control" name="rfid[<%=stt%>]" value="${lstBr.get(index-1).getAsset().getRFID()}" style="display: block; height: 30px; margin: 2px;"></td>
									<td style="text-align: center;"><input type="text" class="form-control" name="model[<%=stt%>]" value="${lstBr.get(index-1).getAsset().getModel()}" style="display: block; height: 30px; margin: 2px;"></td>
									<td style="text-align: center;"><input type="text" class="form-control" name="series[<%=stt%>]" value="${lstBr.get(index-1).getAsset().getSeries()}" style="display: block; height: 30px; margin: 2px;"></td>
									<td style="text-align: center;"><input type="text" class="form-control" name="name[<%=stt%>]" value="${lstBr.get(index-1).getAsset().getName()}" style="display: block; height: 30px; margin: 2px;"></td>
