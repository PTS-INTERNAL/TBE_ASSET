	...
	<div style="padding: 0px;">
		<div class="row">
			<div class="col-sm-12 general-setting shadow-sm p-3 mb-5 bg-gray">
				<form action="ReturnCouponManagement" method="POST">
							...
							<c:forEach var="p" items="${lst}">
								<tr>
									...
									<td align="center"><c:if test="${p.getStatus()=='1'}">
											<form action="ReturnAssetDeclare" method="post" style="width: 160px;">
									...
									<td style="width: 160px;"><c:if test="${p.getStatus()=='1'}">
											<form action="ReturnCouponManagmentDeptApprove" method="post" style="width: 190px;">
												<input style="display: none;" name="coupon_cd" value="${p.getCoupon_cd()}">
											...
											<form action="ReturnCouponManagmentDeptApprove" method="post" style="width: 190px;">
												<input style="display: none;" name="coupon_cd" value="${p.getCoupon_cd()}">
												<button style="width: 190px; margin: auto; background-color: yellow; color: red;" type="submit" class="view" name="approveExport">ĐANG VẬN CHUYỂN</button>
											</form>
										</c:if> <c:if test="${p.getStatus()=='5'}">
											<form action="ReturnCouponManagmentDeptApprove" method="post" style="width: 190px;">
												<input style="display: none;" name="coupon_cd" value="${p.getCoupon_cd()}">
												<button style="width: 190px; margin: auto; background-color: yellow; color: red;" type="submit" class="view" name="approveExport">ĐANG CHO MƯỢN</button>
											</form>
										</c:if>
										
										<c:if test="${p.getStatus()=='6'}">
											<form action="ReturnCouponReturnDeptApprove" method="post" style="width: 190px;">
												<input style="display: none;" name="coupon_cd" value="${p.getCoupon_cd()}">
												<button style="width: 190px; margin: auto; background-color: yellow; color: red;" type="submit" class="view" name="init">XÁC NHẬN TRẢ</button>
											</form>
										</c:if>
										...
										<c:if test="${p.getStatus()=='8'}">
											<form action="ReturnCouponReturnDeptApprove" method="post" style="width: 190px;">
												<input style="display: none;" name="coupon_cd" value="${p.getCoupon_cd()}">
												<button style="width: 190px; margin: auto; background-color: yellow; color: red;" type="submit" class="view" name="approveExport">ĐÃ TRẢ</button>
											</form>
										</c:if>
									...
									<td>
										<form action="ReturnCouponManagement" method="post" style="width: 60px;">
											<input style="display: none;" name="coupon_cd" value="${p.getCoupon_cd()}">
											<c:choose>
