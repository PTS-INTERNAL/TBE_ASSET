							...
							<c:forEach var="p" items="${lst}">
								<tr>
									...
									<td style="width: 160px;"><c:if test="${p.getStatus()=='1'}">
											...
											<form action=BorrowCouponManagmentAccountApprove method="post" style="width: 190px;">
												<input style="display: none;" name="coupon_cd" value="${p.getCoupon_cd()}">
												<button style="width: 190px; margin: auto; background-color: pink; color: black;" type="submit" class="view" name="approveExport">KHO VẬN DUYỆT</button>
											</form>
										</c:if> 
										...
										<c:if test="${p.getStatus()=='7'}">
											<form action=BorrowCouponReturnAccountantApprove method="post" style="width: 190px;">
												<input style="display: none;" name="coupon_cd" value="${p.getCoupon_cd()}">
												<button style="width: 190px; margin: auto; background-color: pink; color: black;" type="submit" class="view" name="init">KẾ TOÁN XN TRẢ</button>
											</form>
										</c:if>
										...
										<c:if test="${p.getStatus()=='4'}">
											<form action="BorrowAssetConfirmReturn" method="post" style="width: 190px;">
												...
												<button type="submit" class="view" style="width: 190px; margin: auto; background-color: red;" name="view_asset">XÁC NHẬN TRẢ</button>
											</form>
