	...
	<div style="padding:0px;">
		<div class="row">
			<div class="col-sm-12 general-setting w3-hide-small w3-light-grey w3-card-2">
				<form action="AssetGeneralRegisterDeclare" method="POST">
						...
						<div class="col-sm-4">
							<div class="form-group">
								<label class="title_input">MÃ RFID:<span class="require">*</span></label> <input type="text"
									class="form-control"  value="${asset.getRFID() }" name="asset_rfid" id="asset_rfid">
							</div>
						</div>
...
document.getElementById("asset_rfid").focus();
</script>
</html>