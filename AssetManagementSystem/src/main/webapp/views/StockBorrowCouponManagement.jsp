							...
							<tr>
								...
								<td colspan="4">
									<label class="radio-inline" style="padding-left: 5px !important;">
										<input value="ALL" type="radio" name="optradio" checked><span>TẤT CẢ</span>
									</label> 
									<label class="radio-inline">
										<input type="radio" name="optradio" value="BORROW"><span>MƯỢN</span>
									</label> 
									<label class="radio-inline">
										<input type="radio" name="optradio" value="LOAN"><span>CHO MƯỢN</span>
									</label> 
									<label class="radio-inline">
										<input type="radio" name="optradio" value="RENT"><span>THUÊ</span>
									</label>
								</td>
							</tr>
						</thead>
