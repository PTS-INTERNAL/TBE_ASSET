					...
					<div class="title-feature">
						<div class="text-right">
							<button type="submit" name="paid" class="btn btn-primary">
								<i style="font-size: 24px" class="fa">&#xf067;</i>XÁC NHẬN TRẢ TÀI SẢN
							</button>
					...
					<div class="row">
						<div class="col-sm-3">
							...
							<input style="display: none;" name="rent_id"
												value="${asset.getRent_cd() }">
								<span class="input-group-addon"> <label
									class="title_input">TÊN TÀI SẢN:<span class="require">*</span></label>
								</span> <input type="text" value="${asset.getAsset().getName()}" readonly="readonly" style="padding-left: 5px;"
						...
						<div class="col-sm-3">
							<div class="form-group">
								...
								</span> <input type="text" value="${asset.getAsset().getModel()}" readonly="readonly" style="padding-left: 5px;"
						...
						<div class="col-sm-3">
							<div class="form-group">
								...
								</span> <input type="text" value="${asset.getAsset().getSeries()}" readonly="readonly" style="padding-left: 5px;"
							...
							<div class="form-group">
								...
								<div class="input-group" style="margin-top:0px;">
									<input type="text" class="form-control inputAssetItem" readonly="readonly"
										name="department_name" value="${asset.getDept_master().getDept_name()}" readonly="readonly"  id="department_name"> <input
					...
					<div class="row">
						<div class="col-sm-4">
							<div class="form-group">
								...
								</span> <input type="text" value="${asset.getComany_client().getCompany_name()}" readonly="readonly" 
						...
						<div class="col-sm-4">
							<div class="form-group">
								...
								</span> <input type="text" value="${asset.getComany_client().getCompany_address()}" readonly="readonly" class="form-control inputAssetItem"
						...
						<div class="col-sm-4">
							<div class="form-group">
								...
								</span> <input type="text" value="${asset.getAsset().getAccountant_CD()}" readonly="readonly" class="form-control inputAssetItem"
									name="accountan_cd">
							</div>
						</div>
						...
						<div class="col-sm-4">
							<div class="form-group">
								...
								</span> <input type="date" value="${asset.getDate_start()}" readonly="readonly" class="form-control inputAssetItem"
									name="date_rent">
						...
						<div class="col-sm-4">
							<div class="form-group">
								...
								</span> <input type="date" value="${asset.getDate_end_schedual()}" readonly="readonly" class="form-control inputAssetItem"
									name="date_paid">
							</div>
						</div>
						...
						<div class="col-sm-4">
							<div class="form-group">
								...
								</span> <input type="text" value="${df}" readonly="readonly" class="form-control inputAssetItem"
									name="price">
							</div>
						</div>
					</div>
