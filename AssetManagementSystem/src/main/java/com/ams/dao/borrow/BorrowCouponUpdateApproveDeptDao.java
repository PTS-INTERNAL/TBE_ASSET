...
public class BorrowCouponUpdateApproveDeptDao {

	BorrowCouponModel br=null;
	public BorrowCouponUpdateApproveDeptDao(BorrowCouponModel br) {
		this.br = br;
	}
	...
	public int excute() throws SQLException
	{
		...
		PreparedStatement sqlStatement = connectString.prepareStatement(getSql());
			...
			sqlStatement.setString(2, br.getApprove_comment());
