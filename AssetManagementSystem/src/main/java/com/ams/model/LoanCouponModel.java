...
public class LoanCouponModel {
	...
	private String coupon_borrow_cd;
	...
	public String getCoupon_borrow_cd() {
		return coupon_borrow_cd;
	}
	public void setCoupon_borrow_cd(String coupon_borrow_cd) {
		this.coupon_borrow_cd = coupon_borrow_cd;
	}
