...
public class PdfChoMuon extends AbstractPdfView {
...
@Override
 protected void buildPdfDocument(Map<String, Object> model, Document document, PdfWriter writer, HttpServletRequest request,
  ...
  ExportBorrowMove  exObject = (ExportBorrowMove) model.get("object");
  ...
  {
	  BorrowAssetModel ex = exObject.getLstBorrow().get(i);
	  phrase = new Phrase();
