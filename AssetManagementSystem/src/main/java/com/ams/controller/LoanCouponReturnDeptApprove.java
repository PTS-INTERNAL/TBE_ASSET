...
@Controller
@RequestMapping("/LoanCouponReturnDeptApprove")
public class LoanCouponReturnDeptApprove {
	String TITLE = "MÀN HÌNH DUYỆT LỆNH TRẢ MƯỢN TÀI SẢN SẢN CỦA ĐƠN VỊ";
	...
	public ModelAndView init(HttpServletRequest request)
	{
		...
		mv.setViewName("views/LoanCouponReturnDeptApprove.jsp");
		return mv;
	}
	...
	public ModelAndView approve(HttpServletRequest request)
	{
		...
		if(isError == 0) {
			...
			LoanCouponUpdateApproveReturnDeptDao updateApprove = new LoanCouponUpdateApproveReturnDeptDao(brCoupn);
			try {
