...
@Controller
@RequestMapping("/BorrowCouponReturnDeptApprove")
public class BorrowCouponReturnDeptApprove {
	String TITLE = "MÀN HÌNH DUYỆT TRẢ CHO MƯỢN TÀI SẢN SẢN CỦA ĐƠN VỊ";
	...
	public ModelAndView init(HttpServletRequest request)
	{
		...
		mv.setViewName("views/BorrowCouponReturnDeptApprove.jsp");
		return mv;
	}
