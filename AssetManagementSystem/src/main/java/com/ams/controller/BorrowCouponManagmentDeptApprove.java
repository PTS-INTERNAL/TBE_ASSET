...
@Controller
@RequestMapping("/BorrowCouponManagmentDeptApprove")
public class BorrowCouponManagmentDeptApprove {
	String TITLE = "MÀN HÌNH DUYỆT PHIẾU CHO MƯỢN TÀI SẢN SẢN CỦA ĐƠN VỊ";
	...
	public ModelAndView init(HttpServletRequest request)
	{
		...
		mv.setViewName("views/BorrowCouponManagmentDeptApprove.jsp");
		return mv;
	}
