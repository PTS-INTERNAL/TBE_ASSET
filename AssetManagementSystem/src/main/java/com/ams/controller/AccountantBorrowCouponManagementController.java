...
@Controller
@RequestMapping("/AccountantBorrowCouponManagement")
public class AccountantBorrowCouponManagementController {
	String TITLE = "MÀN HÌNH QUẢN LÝ PHIẾU CHO MƯỢN TÀI SẢN SẢN CỦA KẾ TOÁN";
	
	@RequestMapping(method = RequestMethod.GET)
	public ModelAndView init(HttpServletRequest request)
	{
		ModelAndView mv = new ModelAndView();
		mv.addObject(ParamsConstants.TITLE_SCREEN, "MÀN HÌNH CHỨC NĂNG KẾ TOÁN");

		
		
		
		mv.setViewName("views/AccountantMenu.jsp");
		return mv;
	}
	
	@RequestMapping(params = "loan",  method = RequestMethod.POST)
	public String initLoan(HttpServletRequest request)
	{
		
		return "redirect:/AccountantLoanCouponManagement";
	}
	
	@RequestMapping(params = "borrow",  method = RequestMethod.POST)
	public ModelAndView initBorrow(HttpServletRequest request)
	{
		ModelAndView mv = new ModelAndView();
		...
		mv.setViewName("views/AccountantBorrowCouponManagement.jsp");
		return mv;
	}
	...
	public ModelAndView Search(HttpServletRequest request)
	{
		...
		coupon.setAccountantApprove(true);
