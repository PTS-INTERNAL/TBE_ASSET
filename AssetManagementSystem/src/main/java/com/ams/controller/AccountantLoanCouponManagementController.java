...
@Controller
@RequestMapping("/AccountantLoanCouponManagement")
public class AccountantLoanCouponManagementController {
	String TITLE = "MÀN HÌNH QUẢN LÝ PHIẾU MƯỢN TÀI SẢN SẢN CỦA KẾ TOÁN";
	...
	public ModelAndView init(HttpServletRequest request)
	{
		...
		mv.setViewName("views/AccountantLoanCouponManagement.jsp");
		return mv;
	}
